...
/**
 * The {@code PharmacistController} class handles operations related to
 * pharmacist authentication, password management, and submission of
 * replenishment requests for inventory items. It interacts with the
 * {@link Repository} to manage data and the {@link Helper} class for user input
 * and utility functions.
 *
 * <p>
 * This class is primarily used by pharmacists to manage their accounts and
 * ensure sufficient stock levels in the inventory.</p>
 *
...
public class PharmacistController {
     ...
     *
     * <p>
     * This method allows pharmacists to request additional stock for medicines
     * that are running low. The request is sent to the admin for approval.</p>
     *
