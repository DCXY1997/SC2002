...
/**
 * StaffController is a controller class that acts as a "middleman" between the
 * view classes - {@link AdminView},  {@link PatientView}, {@link PharmacistView}
 * and {@link Doctor View} and the model class -
 * {@link Admin}, {@link Doctor}, {@link Patient}, {@link Pharmacist} and
 * {@link Staff}.
 * <p>
 *
 * It can authenticate staff, manage passwords, and retrieve staff information
 * by ID. It interacts with the repository to persist staff data and ensure
 * consistency.
 *
 * @author Keng Jia Chi
 * @version 1.0
...
public class StaffController {
     ...
     * This method verifies the credentials against the stored staff data in the
     * repository.
     *
    ...
    /**
     * Changes the password for a given staff member. This method verifies if
     * the new password matches the confirmation password and updates it in the
     * repository.
     *
     ...
     * @return The {@link Staff} object associated with the provided login ID,
