...
/**
 * The Admin class represents an administrator in the system, inheriting from
 * the {@link Staff} class.
 * <p>
 * The Admin class is a specialized type of staff member, always assigned the
 * {@link StaffType#ADMIN} role. It provides constructors for creating
 * administrator accounts with or without parameters.
 * </p>
 *
 * <p>
 * <b>Key Features:</b></p>
...
public class Admin extends Staff {
    ...
    /**
     * For Java Serializable. Ensures compatibility during the serialization and
     ...
     * <p>
     * Creates an Admin object with default values and automatically assigns the
     * {@link StaffType#ADMIN} role.
     * </p>
     */
    public Admin() {
        super();
    ...
    /**
     * Parameterized constructor for creating an Admin object with specified
     * details. Automatically assigns the {@link StaffType#ADMIN} role.
     *
