...
/**
 * The {@code AppointmentStatus} enum represents the various states an appointment can be in
 * within the hospital management system.
 * 
 * <p><b>Enum Constants:</b></p>
 * <ul>
 *   <li>{@link #PENDING} - Indicates the appointment is awaiting confirmation.</li>
 ...
 * </ul>
 * 
 * <p>This enum is used throughout the system to manage and track the status of appointments.</p>
 * 
